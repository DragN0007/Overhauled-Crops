...
public class CilantroBlock extends OCropBlock {
   ...
   public CilantroBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.CILANTRO.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.CILANTRO.get();
   }
