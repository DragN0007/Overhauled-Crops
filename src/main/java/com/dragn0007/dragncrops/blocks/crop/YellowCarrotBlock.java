...
public class YellowCarrotBlock extends OCropBlock {
   ...
   public YellowCarrotBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.YELLOW_CARROTS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.YELLOW_CARROT.get();
   }
