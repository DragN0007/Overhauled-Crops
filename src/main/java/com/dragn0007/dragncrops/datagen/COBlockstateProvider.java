...
//                wildVanillaPlantTexture("wheat_stage7")).renderType("cutout"));
        ...
        createCrop((OCropBlock) COBlocks.TEA.get(), "tea", "tea",
                0, 0, 1, 1, 2, 2, 2, 3);
        ...
        createCrop((OCropBlock) COBlocks.SOYBEANS.get(), "soybeans", "soybeans",
                0, 0, 1, 1, 2, 2, 2, 3);
        simpleBlock(COBlocks.WILD_SOYBEANS.get(), models().cross(COBlocks.WILD_SOYBEANS.getId().getPath(),
                wildPlantTexture("soybeans_stage3")).renderType("cutout"));
