...
public class CORecipeMaker extends RecipeProvider implements IConditionBuilder {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.CANNED_MUSHROOMS.get())
                .requires(COItems.EMPTY_CAN.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.PLUM_PIT.get(), 1)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.THORN_BARLEY_SEEDS.get(), 1)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.RICE_BREAD.get())
                .requires(COItems.RICE.get())
                .requires(COItems.RICE.get())
                .requires(COItems.RICE.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.GRAPE_JAM.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.GRAPE_CANDY.get())
                .requires(COItems.GRAPES.get())
                .requires(COTags.Items.SUGAR)
                .unlockedBy("has_sugar", inventoryTrigger(ItemPredicate.Builder.item()
                        .of(COTags.Items.SUGAR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.GRAPE_TART.get())
                .requires(COItems.GRAPES.get())
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
                .unlockedBy("has_sugar", inventoryTrigger(ItemPredicate.Builder.item()
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.UNFERMENTED_GRAPE_MEAD.get())
                .requires(COItems.GRAPES.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.GRAIN.get())
                .requires(Items.HONEY_BOTTLE)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.BLACKBERRY_COCKTAIL.get())
                .requires(COItems.BLACKBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.BLUEBERRY_COCKTAIL.get())
                .requires(COItems.BLUEBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.CANTALOUPE_COCKTAIL.get())
                .requires(COItems.CANTALOUPE_SLICE.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.CHERRY_COCKTAIL.get())
                .requires(COItems.CHERRIES.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.CRANBERRY_COCKTAIL.get())
                .requires(COItems.CRANBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.MANGO_COCKTAIL.get())
                .requires(COItems.MANGO.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.MELON_COCKTAIL.get())
                .requires(COItems.HONEYDEW_SLICE.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.RASPBERRY_COCKTAIL.get())
                .requires(COItems.RASPBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.STRAWBERRY_COCKTAIL.get())
                .requires(COItems.STRAWBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.GRAPE_COCKTAIL.get())
                .requires(COItems.GRAPES.get())
                .requires(COTags.Items.SUGAR)
                .requires(COItems.COCONUT.get())
                .requires(COItems.LIME.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.PUMPKIN_PIE)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.APPLE_PIE.get())
                .requires(COTags.Items.APPLES)
                .requires(COTags.Items.APPLES)
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.BLACKBERRY_PIE.get())
                .requires(COItems.BLACKBERRY.get())
                .requires(COItems.BLACKBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.BLUEBERRY_PIE.get())
                .requires(COItems.BLUEBERRY.get())
                .requires(COItems.BLUEBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.CHERRY_PIE.get())
                .requires(COItems.CHERRIES.get())
                .requires(COItems.CHERRIES.get())
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.CRANBERRY_PIE.get())
                .requires(COItems.CRANBERRY.get())
                .requires(COItems.CRANBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.RASPBERRY_PIE.get())
                .requires(COItems.RASPBERRY.get())
                .requires(COItems.RASPBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.STRAWBERRY_PIE.get())
                .requires(COItems.STRAWBERRY.get())
                .requires(COItems.STRAWBERRY.get())
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.COCONUT_PIE.get())
                .requires(COItems.COCONUT.get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.BEETROOT_PIE.get())
                .requires(Items.BEETROOT)
                .requires(Items.BEETROOT)
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, COItems.GOLDEN_RHUBARB_PIE.get())
                .requires(COItems.GOLDEN_RHUBARB.get())
                .requires(COItems.GOLDEN_RHUBARB.get())
                .requires(COTags.Items.SUGAR)
                .requires(COTags.Items.FLOUR)
                .requires(COTags.Items.EGG)
