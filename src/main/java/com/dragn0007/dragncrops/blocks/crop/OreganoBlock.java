...
public class OreganoBlock extends OCropBlock {
   ...
   public OreganoBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.OREGANO.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.OREGANO.get();
   }
