...
public class GrapesBlock extends OCropBlock {
   ...
   public GrapesBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.GRAPES.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.GRAPES.get();
   }
