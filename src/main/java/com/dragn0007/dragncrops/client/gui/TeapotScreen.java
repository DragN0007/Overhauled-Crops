...
public class TeapotScreen extends AbstractContainerScreen<TeapotMenu> {
   private static final ResourceLocation LOCATION = new ResourceLocation(CropOverhaul.MODID,"textures/gui/teapot.png");
   private static final int[] BUBBLELENGTHS = new int[]{29, 24, 20, 16, 11, 6, 0};

   public TeapotScreen(TeapotMenu menu, Inventory inventory, Component component) {
   ...
   protected void renderBg(GuiGraphics graphics, float partialTick, int mouseY, int mouseX) {
      ...
      if (i1 > 0) {
         ...
         if (j1 > 0) {
            graphics.blit(LOCATION, i + 63, j + 14 + 29 - j1, 185, 29 - j1, 12, j1);
         }
      }
