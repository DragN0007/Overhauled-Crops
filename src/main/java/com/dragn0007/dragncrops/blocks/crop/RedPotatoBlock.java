...
public class RedPotatoBlock extends OCropBlock {
   ...
   public RedPotatoBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.RED_POTATOES.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.RED_POTATO.get();
   }
