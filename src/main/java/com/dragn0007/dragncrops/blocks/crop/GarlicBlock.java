...
public class GarlicBlock extends OCropBlock {
   ...
   public GarlicBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.GARLIC.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.GARLIC.get();
   }
