...
public class PotMenu extends AbstractContainerMenu {
    ...
    public PotMenu(int i, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(i, inventory, new SimpleContainer(4), new SimpleContainerData(2));
    }

    public PotMenu(int i, Inventory inventory, Container container, ContainerData data) {
        super(COMenuTypes.POT_MENU.get(), i);
