...
public class PurplePotatoBlock extends OCropBlock {
   ...
   public PurplePotatoBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.PURPLE_POTATOES.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.PURPLE_POTATO.get();
   }
