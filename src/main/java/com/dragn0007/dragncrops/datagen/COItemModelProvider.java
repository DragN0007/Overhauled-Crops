...
public class COItemModelProvider extends ItemModelProvider {
    ...
    public void registerModels() {
        ...
        simpleItem(COItems.THORN_BARLEY);
        ...
        simpleItem(COItems.CRIMSONBERRY);
        simpleItem(COItems.GOLDENBERRIES);
        simpleItem(COItems.PEANUT);
        simpleItem(COItems.CUCUMBER);
        simpleItem(COItems.GOLDEN_RHUBARB);
        ...
        simpleItem(COItems.THORN_BARLEY_BREAD);
        ...
        simpleItem(COItems.CANNED_MUSHROOMS);
        ...
        simpleItem(COItems.HERB_SOUP);
        simpleItem(COItems.HERB_CREAM_SOUP);
        ...
        simpleItem(COItems.MUSHROOM_JERKY);
        simpleItem(COItems.FRUIT_JERKY);
        ...
        simpleItem(COItems.CRIMSONBERRY_JAM);
        simpleItem(COItems.GOLDENBERRY_JAM);
        simpleItem(COItems.MANGO_JAM);
        simpleItem(COItems.MELON_JAM);
        simpleItem(COItems.PLUM_JAM);
        ...
        simpleItem(COItems.CRIMSONBERRY_TART);
        simpleItem(COItems.GOLDENBERRY_TART);
        simpleItem(COItems.MANGO_TART);
        simpleItem(COItems.MELON_TART);
        simpleItem(COItems.PLUM_TART);
        ...
        simpleItem(COItems.CRIMSONBERRY_CANDY);
        simpleItem(COItems.GOLDENBERRY_CANDY);
        simpleItem(COItems.MANGO_CANDY);
        simpleItem(COItems.MELON_CANDY);
        simpleItem(COItems.PLUM_CANDY);
        ...
        simpleItem(COItems.CRIMSONBERRY_GELATIN);
        simpleItem(COItems.GOLDENBERRY_GELATIN);
        ...
        simpleItem(COItems.CRIMSONBERRY_COCKTAIL);
        simpleItem(COItems.GOLDENBERRY_COCKTAIL);
        simpleItem(COItems.MANGO_COCKTAIL);
        simpleItem(COItems.MELON_COCKTAIL);
        simpleItem(COItems.PLUM_COCKTAIL);
        ...
        simpleItem(COItems.CRIMSONBERRY_PIE);
        simpleItem(COItems.GOLDENBERRY_PIE);
        simpleItem(COItems.GOLDEN_RHUBARB_PIE);
        simpleItem(COItems.PLUM_PIE);
        ...
        simpleItem(COItems.TEA);
        simpleItem(COItems.APPLE_TEA);
        simpleItem(COItems.BLACKBERRY_TEA);
        simpleItem(COItems.BLUEBERRY_TEA);
        simpleItem(COItems.CANTALOUPE_TEA);
        simpleItem(COItems.CHERRY_TEA);
        simpleItem(COItems.CRANBERRY_TEA);
        simpleItem(COItems.CRIMSONBERRY_TEA);
        ...
        simpleItem(COItems.CRIMSONBERRY_MEAD);
        simpleItem(COItems.GOLDENBERRY_MEAD);
        simpleItem(COItems.MANGO_MEAD);
        simpleItem(COItems.MELON_MEAD);
        simpleItem(COItems.PLUM_MEAD);
        ...
        advancedItem(COItems.UNFERMENTED_CRIMSONBERRY_MEAD, "unfermented_mead");
        advancedItem(COItems.UNFERMENTED_GOLDENBERRY_MEAD, "unfermented_mead");
        ...
        advancedItem(COItems.UNFERMENTED_PLUM_MEAD, "unfermented_mead");
