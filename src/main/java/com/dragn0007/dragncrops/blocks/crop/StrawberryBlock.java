...
public class StrawberryBlock extends OCropBlock {
   ...
   public StrawberryBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.STRAWBERRIES.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.STRAWBERRY.get();
   }
