...
public class PurpleCarrotBlock extends OCropBlock {
   ...
   public PurpleCarrotBlock(BlockBehaviour.Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.PURPLE_CARROTS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.PURPLE_CARROT.get();
   }
