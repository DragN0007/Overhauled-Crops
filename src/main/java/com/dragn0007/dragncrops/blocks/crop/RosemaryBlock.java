...
public class RosemaryBlock extends OCropBlock {
   ...
   public RosemaryBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.ROSEMARY.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.ROSEMARY.get();
   }
