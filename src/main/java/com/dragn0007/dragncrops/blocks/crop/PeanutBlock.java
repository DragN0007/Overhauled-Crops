...
public class PeanutBlock extends OCropBlock {
   ...
   public PeanutBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.PEANUTS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.PEANUT.get();
   }
