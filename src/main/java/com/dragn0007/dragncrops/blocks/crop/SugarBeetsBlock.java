...
public class SugarBeetsBlock extends OCropBlock {
   ...
   public SugarBeetsBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.SUGAR_BEETS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.SUGAR_BEET.get();
   }
