...
public class SoybeansBlock extends OCropBlock {
   ...
   public SoybeansBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.SOYBEANS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.SOYBEAN.get();
   }
