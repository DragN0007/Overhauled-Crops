...
public class AsherbBlock extends OCropBlock {
   ...
   public AsherbBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.ASHERB.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.ASHERB.get();
   }
