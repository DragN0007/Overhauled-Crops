...
public class CucumbersBlock extends OCropBlock {
   ...
   public CucumbersBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.CUCUMBERS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.CUCUMBER.get();
   }
