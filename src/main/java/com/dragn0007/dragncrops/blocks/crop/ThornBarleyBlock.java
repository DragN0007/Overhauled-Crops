...
public class ThornBarleyBlock extends OCropBlock {
   ...
   public ThornBarleyBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.THORN_BARLEY.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.THORN_BARLEY_SEEDS.get();
   }
   ...
   public boolean mayPlaceOn(BlockState p_52302_, BlockGetter p_52303_, BlockPos p_52304_) {
      return p_52302_.is(Blocks.WARPED_NYLIUM) || p_52302_.is(Blocks.SOUL_SOIL) || p_52302_.is(Blocks.SOUL_SAND);
   }
