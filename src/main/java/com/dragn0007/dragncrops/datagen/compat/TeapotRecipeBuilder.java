...
public class TeapotRecipeBuilder implements RecipeBuilder {
    private final Item result;
    private final Ingredient ingredient;
    private final int count;
    private final Advancement.Builder advancement = Advancement.Builder.advancement();

    public TeapotRecipeBuilder(ItemLike ingredient, ItemLike result, int count) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(CropOverhaul.MODID,
                    ForgeRegistries.ITEMS.getKey(this.result).getPath() + "_from_teapot");
        }
