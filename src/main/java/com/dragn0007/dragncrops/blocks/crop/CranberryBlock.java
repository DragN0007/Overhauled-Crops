...
public class CranberryBlock extends OCropBlock {
   ...
   public CranberryBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.CRANBERRIES.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.CRANBERRY.get();
   }
