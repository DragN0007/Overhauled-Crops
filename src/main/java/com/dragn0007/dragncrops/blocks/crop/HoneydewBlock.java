...
public class HoneydewBlock extends OCropBlock {
   ...
   public HoneydewBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return COBlocks.HONEYDEW.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return COItems.HONEYDEW_SLICE.get();
   }
